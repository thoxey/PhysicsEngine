...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile PhysicsEngine.pro
#############################################################################
...
CXXFLAGS      = -pipe -I/usr/local/include/SDL2 -D_REENTRANT -g -std=c++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = physics1.0.0
DISTDIR = /home/i7469704/Documents/PhysicsEngine/obj/physics1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -L/usr/local/lib/ -lSDL2 -lGLU -lSDL2_image -ljpeg -L/opt/qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		PhysicsEngine.pro src/world.h \
		src/gameobject.h \
		src/staticcircle.h \
		src/dynamicobject.h \
		src/dynamiccircle.h \
		src/button.h src/main.cpp \
		src/world.cpp \
		src/gameobject.cpp \
		src/staticcircle.cpp \
		src/dynamicobject.cpp \
...
Makefile: PhysicsEngine.pro /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/world.h src/gameobject.h src/staticcircle.h src/dynamicobject.h src/dynamiccircle.h src/button.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/world.cpp src/gameobject.cpp src/staticcircle.cpp src/dynamicobject.cpp src/dynamiccircle.cpp src/button.cpp $(DISTDIR)/
...
obj/main.o: src/main.cpp src/world.h \
		src/gameobject.h \
		src/dynamicobject.h \
		src/dynamiccircle.h \
		src/staticcircle.h \
...
obj/staticcircle.o: src/staticcircle.cpp src/staticcircle.h \
		src/gameobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/staticcircle.o src/staticcircle.cpp

obj/dynamicobject.o: src/dynamicobject.cpp src/dynamicobject.h \
		src/gameobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/dynamicobject.o src/dynamicobject.cpp

obj/dynamiccircle.o: src/dynamiccircle.cpp src/dynamiccircle.h \
		src/dynamicobject.h \
		src/gameobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/dynamiccircle.o src/dynamiccircle.cpp
